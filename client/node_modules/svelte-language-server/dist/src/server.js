...
function startServer(options) {
    ...
    connection.onInitialize((evt) => {
        ...
        pluginHost.updateConfig(((_g = evt.initializationOptions) === null || _g === void 0 ? void 0 : _g.config) || {});
        pluginHost.register((sveltePlugin = new plugins_1.SveltePlugin(configManager, (_h = evt.initializationOptions) === null || _h === void 0 ? void 0 : _h.prettierConfig)));
        pluginHost.register(new plugins_1.HTMLPlugin(docManager, configManager, (_j = evt.initializationOptions) === null || _j === void 0 ? void 0 : _j.emmetConfig));
        pluginHost.register(new plugins_1.CSSPlugin(docManager, configManager, (_k = evt.initializationOptions) === null || _k === void 0 ? void 0 : _k.emmetConfig));
