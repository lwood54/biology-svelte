...
class CSSPlugin {
    constructor(docManager, configManager, emmetConfig) {
        this.emmetConfig = emmetConfig;
    ...
    getCompletions(document, position, completionContext) {
        ...
        if (isSASS(cssDocument)) {
            ...
            return vscode_emmet_helper_1.doComplete(document, position, 'sass', this.emmetConfig || {});
        }
        ...
        lang.setCompletionParticipants([
            vscode_emmet_helper_1.getEmmetCompletionParticipants(cssDocument, cssDocument.getGeneratedPosition(position), service_1.getLanguage(type), this.emmetConfig || {}, emmetResults)
        ]);
